...
<link rel="stylesheet" href="https://d1e2y5wc27crnp.cloudfront.net/web/style_4.css">
            ...
            <script async src="https://www.googletagmanager.com/gtag/js?id=AW-804830038"></script>
            <script>
		...
		<div class="section" id="first-section">
			...
			<div id="bar-image-container">
				<div class="bar-images hide--mobile">
					<img src="/bangbang/resources/imageContainer/1.jpg" alt="1" class="bar-image">
					<img src="/bangbang/resources/imageContainer/2.jpg" alt="2" class="bar-image">
					<img src="/bangbang/resources/imageContainer/3.jpg" alt="3" class="bar-image">
				</div>
				<div class="bar-images hide--mobile">
					<img src="/bangbang/resources/imageContainer/4.jpg" alt="4" class="bar-image">
					<img src="/bangbang/resources/imageContainer/5.jpg" alt="5" class="bar-image">
					<img src="/bangbang/resources/imageContainer/6.jpg" alt="6" class="bar-image">
				</div>
				<div class="bar-images hide--mobile">
					<img src="/bangbang/resources/imageContainer/7.jpg" alt="7" class="bar-image">
					<img src="/bangbang/resources/imageContainer/8.jpg" alt="8" class="bar-image">
					<img src="/bangbang/resources/imageContainer/9.jpg" alt="9" class="bar-image">
				</div>
			</div>
				...
				<div class="text-container">
					...
					<div class="counts">
						<div>
							...
							<div id="pickup-bar-count" class="count-content">&nbsp;<span data-count="817">0</span>개</div>
						</div>
						<div>
							<div class="count-label">상품</div>
							<div id="pickup-product-count" class="count-content">&nbsp;<span data-count="130">0</span>개</div>
						</div>
					</div>


					<p class="description">
            원하는 술 찾으러 돌아다니기 불편하셨나요?<br class="hide--mobile"/>
            술에 대한 정보를 찾기 어려우셨나요?
					</p>
