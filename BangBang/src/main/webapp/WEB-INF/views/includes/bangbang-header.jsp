...
<link href="/bangbang/resources/getboot/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      ...
      .title-font{
		font-family: 'Song Myung', serif; color: black; font-size: 40px; text-decoration: none;
	  }
	  
	   .title-font:hover{
		font-family: 'Song Myung', serif; color: gray; font-size: 40px; text-decoration: none;
	  }
	  
	  .nav-font{
	    font-family: 'Noto Sans KR', sans-serif; text-decoration: none; padding: 8px; color: black; font-size:18px; 
	  }	
