...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
  ...
  <div class="navbar-collapse offcanvas-collapse ml-4" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
		...
		<li class="nav-item">
		<a class="nav-link" href="${pageContext.request.contextPath}/member/my/mypage">마이페이지</a></li>
		...
		<li class="nav-item">
		<a class="nav-link" href="${pageContext.request.contextPath}/guestbook/write">방명록 글쓰기</a></li>
		<li class="nav-item">
		<a class="nav-link" href="${pageContext.request.contextPath}/guestbook/list">방명록 리스트</a></li>
    ...
    <div>
		...
		<sec:authorize access="isAuthenticated()">
			<table>
				<tr>
					<td><img class="rounded" src="${pageContext.request.contextPath}/uploadfile/${user.member.photo}" style="height:25px;width:25px;"></td>
					<td>
					<span  class="text-warning">${user.member.username}(${user.member.userid})</span> 
    ...
    <%-- <c:if test="${empty loginInfo}">
		...
		<c:if test="${not empty loginInfo}">
			<table>
				<tr>
					<td><img class="rounded" src="${pageContext.request.contextPath}/uploadfile/${loginInfo.photo}" style="height:25px;width:25px;"></td>
					<td>
					<span  class="text-warning">${loginInfo.userName}(${loginInfo.userId})</span> 
					<a class="btn btn-info btn-sm" href="${pageContext.request.contextPath}/member/logout">logout</a>
					</td>
				</tr>
			</table>
